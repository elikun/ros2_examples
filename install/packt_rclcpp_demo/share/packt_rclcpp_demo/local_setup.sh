...
: ${AMENT_CURRENT_PREFIX:="/colcon_ws/install/packt_rclcpp_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/packt_rclcpp_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/packt_rclcpp_demo/environment/path.sh"
